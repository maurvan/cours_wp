<?php
/**
 * Plugin Name: Current Template Name
 * Description: Get current template name on adminbar. It also shows Included file names of the template and wordpress current version and the current theme name.It just says to show current template, which template file you are still in.
 * Version: 1.1.7
 * Author: WPFeel
...
Final Class CurrentTemplateName {
    /**
     * plugin version
     * 
     * @var string 
    ...
    /**
     * Setup CurrentTemplateName functions.
     *
     * @since 1.0.0
     * @return void
     */
    ...
    /**
     * Define CurrentTemplateName Constants.
     *
     * @since 1.0.0
     * @return void
     */
...
if( ! function_exists('current_template_name') ) {
    function current_template_name() {
        return CurrentTemplateName::instance();
    }
}
