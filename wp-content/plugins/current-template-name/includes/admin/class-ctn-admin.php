    ...
    function ctn_options_page() {
        ...
        <div class="wrap ctn-setting-wrap">
            <form action='options.php' method='post'>
                <?php
                echo sprintf('<h1>%s</h1>', esc_html__( "Current Template Name", "current-template-name" ) );
                echo sprintf('<p>%s</p>', esc_html__( "This is where you can set current template name options.", "current-template-name" ) );
                ?>
