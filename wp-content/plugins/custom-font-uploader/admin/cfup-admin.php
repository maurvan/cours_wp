...
if ( ! class_exists( 'Cfup_AdminPage' ) ) {
	...
	class Cfup_AdminPage {
		...
		function cfup_admin_settings_page() {
			$tab = isset( $_GET['tab'] ) ? $_GET['tab'] : 'cfup-welcome';
			?>
                        <div class="wrap">
		...
		function cfup_plugin_settings_tabs() {
			$current_tab = isset( $_GET['tab'] ) ? $_GET['tab'] : 'cfup-welcome';
			echo '<div class="wbcom-tabs-section"><div class="nav-tab-wrapper"><div class="wb-responsive-menu"><span>' . esc_html( 'Menu' ) . '</span><input class="wb-toggle-btn" type="checkbox" id="wb-toggle-btn"><label class="wb-toggle-icon" for="wb-toggle-btn"><span class="wb-icon-bars"></span></label></div><ul>';
			foreach ( $this->plugin_settings_tabs as $tab_key => $tab_caption ) {
				$active = $current_tab == $tab_key ? 'nav-tab-active' : '';
				echo '<li><a class="nav-tab ' . esc_attr( $active ) . '" href="?page=' . $this->plugin_slug . '&tab=' .  $tab_key . '">' . esc_html( $tab_caption ) . '</a></li>';
			}
			echo '</div></ul></div>';
		}
		...
		function cfup_register_general_settings() {
                        ...
                        add_settings_section( 'cfup_welcome_settings', ' ', array( &$this, 'cfup_welcome_page_content' ), 'cfup-welcome' );
			...
			add_settings_section( 'section_general', ' ', array( &$this, 'cfup_general_settings_section' ), 'cfup-general-settings' );
                ...
                function cfup_welcome_page_content() {
