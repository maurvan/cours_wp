 ...
 */
add_action( 'activated_plugin', 'cfup_activation_redirect_settings' );
function cfup_activation_redirect_settings( $plugin ){

	if( $plugin == plugin_basename( __FILE__ ) ) {
		wp_redirect( admin_url( 'admin.php?page=custom-font-uploader-settings' ) ) ;
		exit;
	}
}
